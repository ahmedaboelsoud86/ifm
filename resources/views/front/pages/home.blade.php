...
<html lang="en">
  ...
  <body>
    <header class="header">
      <div class="container">
        <div class="logo"><a href="{{ url('/'.app()->getLocale() )}}" title="Takamul AlOula Facility Management "> <img class="logowight" src="{{ asset('assets/images/logo.png') }}" alt="Takamul AlOula Facility Management " title="Takamul AlOula Facility Management " loading="lazy"><img class="logodork" src="{{ asset('assets/images/logodork.png') }}" alt="Takamul AlOula Facility Management " title="Takamul AlOula Facility Management " loading="lazy"></a></div>
        ...
        <nav class="navbar" id="navbar"><span class="cancel">
          ...
          <ul class="menu" id="menu">
            <li class="menu-item activelink"><a class="menu-link" href="{{ url('/'.app()->getLocale() )}}">@lang("site.home")</a></li>
            <li class="menu-item"><a class="menu-link" href="{{ route('aboutus') }}">@lang("site.aboutus")</a></li>
            <li class="menu-item"><a class="menu-link" href="{{ route('services') }}">@lang("site.services_solutions")</a></li>
            <li class="menu-item"><a class="menu-link" href="{{ route('clients') }}">@lang("site.clients")</a></li>
            <li class="menu-item"><a class="menu-link" href="{{ route('news') }}">@lang("site.news")</a></li>
            <li class="menu-item"><a class="menu-link" href="{{ route('contact_us') }}">@lang("site.contact_us")</a></li>
          </ul>
        </nav>
        <div class="icon"><span class="searchicon">
            ...
            </svg></span><a class="language" href="{{ LaravelLocalization::getLocalizedURL(app()->getLocale() == 'ar'? 'en' : 'ar', null, [], true) }}">
            ...
            </svg>{{ app()->getLocale() == 'ar' ? 'en' : 'ar' }}</a></div>
